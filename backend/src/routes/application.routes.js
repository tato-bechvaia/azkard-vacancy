...
const { applyToJob, myApplications, jobApplicants, updateStatus, viewCv } = require('../controllers/application.controller');
...
router.post('/:id/view-cv',   protect, requireRole('EMPLOYER'),  viewCv);
